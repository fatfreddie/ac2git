...
class Config(object):
    ...
    def fromxmlstring(cls, xmlString):
        ...
        if xmlRoot is not None and xmlRoot.tag == "accurev2git":
            ...
            return cls(accurev=accurev, git=git, usermaps=usermaps, method=method, logFilename=logFilename, messageFormat=msgFormat)
        else:
    ...
    def __init__(self, accurev = None, git = None, usermaps = None, method = None, logFilename = None, messageFormat = None):
